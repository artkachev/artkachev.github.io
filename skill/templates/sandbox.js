(function () {
  ...
  function sheet() {
    ...
    f3.appendChild(el("p", "hint",
      "Работа пропадёт с витрины и из каталога, и сборка перестанет делать её " +
      "страницу. Уже собранная страница останется лежать по прежнему адресу и " +
      "устареет — Клод спросит, удалить её или оставить."));
    card.appendChild(f3);
